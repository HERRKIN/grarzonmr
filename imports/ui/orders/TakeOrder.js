  ...
  this.setState({
    ...
    render() {
       switch (this.state.step) {
			case 1:
				return <Starters  nextStep={this.nextStep}
                           order = {Order} 
                           starters = {this.props.entradas}
                           saveValues={this.saveValues}/>
			case 2:
				return <MainCourses  nextStep={this.nextStep}
                           previousStep={this.previousStep}
                           order = {Order} 
                           starters = {this.props.principales}
                           saveValues={this.saveValues}/>
			case 3:
				return <Desserts nextStep={this.nextStep}
                           previousStep={this.previousStep} 
                           order = {Order} starters = {this.props.postres}
                           saveValues={this.saveValues}/>
			case 4:
				return <Confirmation  order = {Order} submitOrder={this.submitOrder}/>
			case 5:
